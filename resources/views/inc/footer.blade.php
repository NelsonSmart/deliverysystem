        ...
        <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-4">
                <div class="footer__widget-content">
                  <img src="{{ asset('assets/images/logo/logo-dark.png')}}" alt="logo" width="134px" height="43px" class="mb-30">
                </div>
              </div>
...
@if($settings->widget != '' || $settings->widget != null )
    	{!! $settings->widget !!}
@endif